...
useEffect(()=>{
    ...
    const delCart=async()=>{
        try {
            ...
            const data = await response.json();
            alert("All Cart Deleted from Cart");
        } catch (error) {
            console.error('Error fetching categories:', error);
        }
        getCart();
                            ...
                            {cart.map((e)=>{
                                return(
                                    <tr>
                                        ...
                                        <img src="https://live.staticflickr.com/1162/1417817516_5f85646065_n.jpg" alt="#" />
                                        </td>
                                        ...
                                        <a href="#" className="text-muted">
                                            <button onClick={() => removeCart(e._id)}>
