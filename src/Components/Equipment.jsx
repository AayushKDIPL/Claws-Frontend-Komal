...
function Equipment() {
 ...
 className="box-2">
          ...
          <Link to={"/equipment/Others"}><button type="button" className="btn1 bt-red"> View Equipment</button> </Link>
        </div>
      </div>
    </div>
    <div className="equip-container">
     ...
     data-aos-duration="1500" className="box-2">
          ...
          <Link to={"/merchandise/tshirt"}><button type="button" className="btn1 bt-red">View Merchandise</button></Link>
        </div>
      </div>
      <div className="equip-box equip-box1">
        <div data-aos="fade-right">
