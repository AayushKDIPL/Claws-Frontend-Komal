      ...
      <div className="box3">
        <div className="container main_div">
          <div className="card">
            ...
            <h1 className="card_title"><Link to="/merchandise/tshirt" className='linkit' >TSHIRT</Link></h1>
          </div>
          <div className="card">
            <img className="card_img" src={FAT_GRIP} alt="Fat Grip" />
            <h1 className="card_title"><Link to="/equipment/Others" className='linkit' >FAT GRIP</Link></h1>
          </div>
          <div className="card">
            <img className="card_img" src={table} alt="Table" />
            <h1 className="card_title"><Link to="/equipment/Others" className='linkit' >TABLE</Link></h1>
          </div>
          <div className="card">
            <img className="card_img" src={cable} alt="Cable" />
            <h1 className="card_title"><Link to="/equipment/Others" className='linkit' >CABLE</Link></h1>
          </div>
        </div>
      </div>
    </div>
